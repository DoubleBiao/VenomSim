...
dronesimapi.simcontrol.argtype = [c_char,c_char,c_char,\
...
def simcontrol(huntercmd,targetcmd = None):
    if targetcmd:
        dronesimapi.simcontrol(c_char(huntercmd[0]),c_char(huntercmd[1]),c_char(huntercmd[2]),c_char(huntercmd[3]),\
                                       c_char(targetcmd[0]),c_char(targetcmd[1]),c_char(targetcmd[2]),c_char(targetcmd[3]))
    else:
        dronesimapi.simcontrol(c_char(huntercmd[0]),c_char(huntercmd[1]),c_char(huntercmd[2]),c_char(huntercmd[3]),\
                                       c_char(0),c_char(0),c_char(0),c_char(0))
